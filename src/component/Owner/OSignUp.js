...
const OSignUp = () => {
    ...
    const submitForm =(event) =>{
        ...
        connection.post("/api/v1/auth/Ownerregister", newUser)
        .then(response => {
            toast.success("created Successfully !! user id "+response.data.ownerId)
                ...
                <Row className="mt-4">
                    ...
                    <CardBody>
                        <Form onSubmit={submitForm}>
                            ...
                            <Container>
                                <Button color="dark" className="mt-2" tag={ReactLink} to="/owner-login">If you are already Register Click here</Button>
                            </Container>
                        </Form>
                    </CardBody>
